...
- `history`: the history of the conversation, this can be used to keep a conversational memory
...
- `context`: optionally, if no history was specified the context will be returned as an encoding of the conversation used in this response, this field is deprecated and will be removed in a future version
...
To continue a conversation, you can provide a `history` parameter. This is a list of prompts and responses.
